...
class ChartStatusDataMonitor {
  final String statusDispositivo;
  final int quantidade;

  ChartStatusDataMonitor(
      {required this.statusDispositivo, required this.quantidade});
}

// ignore: must_be_immutable
class StatusMonitorChart extends StatelessWidget {
  final List<ChartStatusDataMonitor> chartStatusDataMonitor;
  final double radiusHeight;

  StatusMonitorChart(
      {super.key,
      required this.chartStatusDataMonitor,
  ...
  Widget build(BuildContext context) {
    return SfCircularChart(
      ...
      series: <CircularSeries>[
        DoughnutSeries<ChartStatusDataMonitor, String>(
          ...
          dataSource: chartStatusDataMonitor,
          xValueMapper: (ChartStatusDataMonitor series, _) =>
              series.statusDispositivo,
          yValueMapper: (ChartStatusDataMonitor series, _) => series.quantidade,
