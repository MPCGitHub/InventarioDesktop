...
class TabelaMobile extends StatefulWidget {
...
class _TabelaItensState extends State<TabelaMobile> {
  @override
  void initState() {
    super.initState();
    widget.mobileManager.addListener(_onMobileManagerChange);
  }

  @override
  void dispose() {
    widget.mobileManager.removeListener(_onMobileManagerChange);
    super.dispose();
  }

  void _onMobileManagerChange() {
    setState(() {
          ...
          child: Consumer<MobileManager>(
            builder: (_, mobileManager, __) {
              return DataTable(
                ...
                rows: mobileManager.allMobiles.map((celular) {
                  return DataRow(cells: [
                    ...
                    if (widget.showAtivoColumn)
                      DataCell(Text(celular.status_dispositivo)),
